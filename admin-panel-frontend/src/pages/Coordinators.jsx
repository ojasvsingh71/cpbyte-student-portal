...
import { getAllCoordinators, deleteUser } from "../store/adminslice";
...
const CoordinatorsTable = () => {
  ...
  const { coordinators, loading, error } = useSelector((state) => state.admin);
  ...
  const filteredUsers = coordinators.filter((user) =>
    Object.values(user)
      .join(" ")
      .toLowerCase()
  ...
  return (
    ...
    <div className="overflow-x-auto p-4">
      <h5 className="text-xl font-semibold mb-2">Coordinators Data</h5>
      <p className="text-gray-500 text-sm mb-4">
        List of registered Coordinators and their details.
      </p>
